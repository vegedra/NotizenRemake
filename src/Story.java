...
public class Story {
    ...
    public static void main(String[] args) {
        ...
        Story game;
        // 'game' guarda a nova instância (novo objeto da classe Game)
        game = new Story();
    ...
    // Evento: Quando o jogador encontra a carteira
    public void encontraCarteira() {
        System.out.println("Você começa a subir uma rua ingreme. Você começa a se sentir cansado.\n");
        ...
        if (player.haveItem("Carteira perdida")) {
            ...
            // Sim
            if (choice == 1){
                System.out.println("Você continua subindo a rua, mas, se depara com uma rua sem saída.\n");
                pressEnter();
                north();
            }
            // Voltar
    ...
    public void endDayOne() {
        ...
        System.out.println("\nSua reputação na cidade: " + playerRep);
        System.out.println("Nível de suspeição das autoridades: " + playerSuspicion);
        pressEnter();
        System.exit(0);
    }
}
